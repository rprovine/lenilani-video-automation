...
class TopicGenerator:
    ...
    def generate_video_concept(self) -> Dict[str, any]:
        ...
        return {
            ...
            "clip_1_prompt": f"""Cinematic portrait video (9:16 vertical): A stressed {business_type} owner in {location}, Hawaii {problem['scenario']}. Camera slowly zooms in on their frustrated, exhausted expression. Their workspace is chaotic and disorganized. Warm natural lighting. Professional office setting with tropical plants visible. High-quality commercial cinematography, shallow depth of field, 8 seconds.""",

            "clip_2_prompt": f"""Cinematic portrait video (9:16 vertical): Same {business_type} owner in {location} now discovering {solution}. Their face lights up with hope and excitement as they see the solution on their laptop screen showing LeniLani Consulting branding. Modern clean office with organized workspace. Camera pans from concerned to relieved expression. Bright, hopeful lighting with ocean view through window. Professional commercial quality, 8 seconds.""",

            "clip_3_prompt": f"""Cinematic portrait video (9:16 vertical): {business_type} owner in {location} now thriving and confident. They're working efficiently with AI dashboard visible on screen, smiling and relaxed. Happy customers visible in background. Clean, modern office space. Warm golden hour lighting. Camera shows before/after transformation moment. Professional success story aesthetic, vibrant colors, 8 seconds.""",
